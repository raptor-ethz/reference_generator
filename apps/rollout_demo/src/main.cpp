...
int main()
{
  ...
  quad.goToPos(drop_vec.at(0), -0.490158, 2, 0, 4000, false);
  quad.goToPos(drop_vec.at(0) - 0.15, drop_vec.at(1) - 0.2, 2, 0, 4000, false);
  quad.goToPos(drop_vec, -0.15, -0.2, 0.5, 0, 4000, false);
  gripper.setAngleSym(80);
  quad.goToPos(drop_vec.at(0) - 0.15, drop_vec.at(1) - 0.2, 2.75, 0, 4000, false);
  quad.goToPos(pick_vec.at(0) - 0.11, pick_vec.at(1) + 0.03, 2.75, 0, 4000, false);
  quad.goToPos(pick_vec, -0.11, 0.01, 0.62, 0, 4000, false);

  // PICK UP BOTTLE
  // quad.goToPos(pick_vec, -1.0, 0.035, 0.65, 0, 3000, false);
  // quad.goToPos(pick_vec, -0.11, 0.035, 0.65, 0, 4000, false);
  quad.goToPos(pick_vec, -0.11, 0.01, 0.28, 0, 6000, false);
  gripper.setAngleSym(0);
  std::this_thread::sleep_for(std::chrono::milliseconds(150));
  quad.goToPos(pick_vec, -0.11, 0.01, 0.65, 0, 4000, false);
  quad.goToPos(pick_vec, -1.0, 0.01, 0.65, 0, 4000, false);
